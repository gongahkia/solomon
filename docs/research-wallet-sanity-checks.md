# stonks-cli Wallet Sanity Checks (#15)
...
```sh
PYTHONPATH=src python3 -m stonks_cli research wallets rank \
  --fixture tests/fixtures/research/wallet-attribution.jsonl \
  --limit 100 \
  --markdown
```
...
Top-10 is selected from [May 2026 wallet activity shortlist](research-wallet-activity-shortlist-2026-05.md), not from profitability attribution.
