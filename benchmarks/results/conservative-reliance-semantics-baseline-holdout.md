...
| --- | ---: | ---: |
| reference precision | 0.9 | 36/40 |
| reference recall | 0.923077 | 36/39 |
| target resolution precision | 0.9 | 36/40 |
| target resolution recall | 0.923077 | 36/39 |
| suggestion precision | 0.428571 | 3/7 |
| suggestion recall | 0.2 | 3/15 |
| exact evidence span accuracy | 0.2 | 3/15 |
| overlap or containment span accuracy | 0.2 | 3/15 |
| abstention accuracy | 0.84 | 21/25 |
| hard negative false positive rate | 0.1875 | 3/16 |
| duplicate suggestion rate | 0.0 | 0/7 |
| suggestions per 100 items | 17.5 | 700/40 |
| false positive suggestions per 100 items | 10.0 | 400/40 |
...
| reference not detected | 4 |
| reliance cue not recognized | 11 |
