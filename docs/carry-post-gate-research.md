...
| opportunity scanner expansion | After Carry live validation and separate approval. | SG-legal venue list, capital caps, one-click execution arm flag, public opportunity ledger. |

## Non-Blocking Rule

These research tracks do not unblock initial Hyperliquid Carry work. They must not delay scanner, paper engine, audit ledger, Pi ops, or tiny-live safety work.

## Required Proposal Template

Any expansion proposal must record:

- stonks-cli date and operator.
...
- Abandon criteria from [Carry abandon report template](carry-abandon-report-template.md).
