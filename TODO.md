...
2. [D] Insert new PRD §3.5 "Why infra-first, not destination app". Anchor on May-2026 Anthropic 20+ MCP connector launch, Copilot-in-M365, Spellbook-in-Word as evidence that embedded > destination.
