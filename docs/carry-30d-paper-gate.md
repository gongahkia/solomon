# stonks-cli 30-Day Carry Paper Gate

Status: active acceptance contract for GitHub issue #14.

Carry cannot progress to tiny live execution until a continuous 30-day paper run satisfies all pass criteria.
...
Post-gate broker-basis and cross-exchange research is governed by [Carry post-gate research](carry-post-gate-research.md).
