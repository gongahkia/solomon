...
2.times do |index|
  ...
  response = '{"v":2,"prompt":"fake-fish> ","right_prompt":"right-fish","redraw_token":null}'
...
XDG_CONFIG_HOME="$xdg" fish -c 'source init/shisa.fish; test "$SHISA_CMD_COMPLETE_BELL" = 1; test "$SHISA_CMD_COMPLETE_BELL_MODE" = osc9; test "$SHISA_CMD_COMPLETE_BELL_THRESHOLD_MS" = 2500; test "$SHISA_CMD_COMPLETE_BELL_MESSAGE" = done'
