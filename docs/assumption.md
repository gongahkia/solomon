...
- Solomon is self-contained; the boundary engine is in `src/solomon/boundary/engine/`.
- The Solomon boundary and currency engine are operated by the same firm boundary owner.
