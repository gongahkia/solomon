...
Opt-in cloud providers are documented in [OpenAI Provider](ai-openai.md), [Anthropic Provider](ai-anthropic.md), and [Gemini Provider](ai-gemini.md). The local LM Studio provider is documented in [LM Studio Provider](ai-lmstudio.md). Privacy rules live in [AI Privacy](ai-privacy.md).
