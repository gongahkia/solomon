...
| --- | ---: | ---: |
| reference precision | 0.818182 | 27/33 |
| reference recall | 0.771429 | 27/35 |
| target resolution precision | 0.878788 | 29/33 |
| target resolution recall | 0.828571 | 29/35 |
| suggestion precision | 0.833333 | 10/12 |
| suggestion recall | 0.555556 | 10/18 |
| exact evidence span accuracy | 0.444444 | 8/18 |
| overlap or containment span accuracy | 0.444444 | 8/18 |
| abstention accuracy | 0.933333 | 14/15 |
| hard negative false positive rate | 0.083333 | 1/12 |
| duplicate suggestion rate | 0.0 | 0/12 |
| suggestions per 100 items | 37.5 | 1200/32 |
| false positive suggestions per 100 items | 6.25 | 200/32 |
...
| attributed other party | 1 | 0.0/1.0 | 0.0 | 1.0 |
...
| cross sentence reliance | 1 | 1.0/0.0 | 1.0 | 1.0 |
...
| reliance without legacy cue | 1 | 1.0/0.0 | 1.0 | 1.0 |
| revision introduces reliance | 1 | 1.0/1.0 | 1.0 | 1.0 |
| revision removes reliance | 1 | 1.0/1.0 | 1.0 | 0.0 |
| same document different scope | 1 | 1.0/0.0 | 1.0 | 1.0 |
...
| Stage | Count |
| --- | ---: |
| cross sentence relationship missed | 1 |
| evidence span over broad | 2 |
| mention mistaken for reliance | 1 |
| quoted or attributed position mistaken for firm reliance | 1 |
| reference not detected | 12 |
| reliance cue not recognized | 3 |
