...
Opt-in cloud providers are documented in [OpenAI Provider](ai-openai.md), [Anthropic Provider](ai-anthropic.md), and [Gemini Provider](ai-gemini.md). Local non-Ollama providers are documented in [LM Studio Provider](ai-lmstudio.md) and [llama.cpp Provider](ai-llamacpp.md). Privacy rules live in [AI Privacy](ai-privacy.md).
