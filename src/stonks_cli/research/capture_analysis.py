...
def analyze_capture_archive(
    *,
    ...
    """Analyze an archived Research capture without changing source files."""
...
def _render_analysis_markdown(summary: dict[str, Any]) -> str:
    lines = [
        "# Research Partial Capture Analysis",
        "",
        "## Gate Context",
        "",
...
def _render_executive_summary(summary: dict[str, Any]) -> str:
    ...
    projection = summary["projection"]
    lines = [
        "# Research Partial Capture Executive Summary",
        "",
        "## Main Takeaway",
        "",
        "The partial live capture is useful enough to continue exploratory Research analysis, but it does not satisfy the formal 7-day clean-capture validation gate.",
        "",
