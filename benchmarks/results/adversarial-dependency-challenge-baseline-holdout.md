...
| --- | ---: | ---: |
| reference precision | 0.86 | 43/50 |
| reference recall | 0.826923 | 43/52 |
| target resolution precision | 0.86 | 43/50 |
| target resolution recall | 0.826923 | 43/52 |
| suggestion precision | 0.642857 | 9/14 |
| suggestion recall | 0.45 | 9/20 |
| exact evidence span accuracy | 0.45 | 9/20 |
| overlap or containment span accuracy | 0.45 | 9/20 |
| abstention accuracy | 0.941176 | 32/34 |
| hard negative false positive rate | 0.1 | 2/20 |
| duplicate suggestion rate | 0.0 | 0/14 |
| suggestions per 100 items | 26.923077 | 1400/52 |
| false positive suggestions per 100 items | 9.615385 | 500/52 |
...
| attributed other party | 2 | 0.0/1.0 | 0.0 | 1.0 |
...
| reliance without legacy cue | 2 | 1.0/0.0 | 1.0 | 1.0 |
...
| Stage | Count |
| --- | ---: |
| cross sentence relationship missed | 2 |
| mention mistaken for reliance | 3 |
| quoted or attributed position mistaken for firm reliance | 2 |
| reference not detected | 15 |
